...
namespace WinDbFirst1
{
    ...
    public partial class NorthwindEntities1 : DbContext
    {
        ...
        public virtual DbSet<UrunlereGoreDagilimi> UrunlereGoreDagilimi { get; set; }
        public virtual DbSet<UrunlereGoreDagilimi2> UrunlereGoreDagilimi2 { get; set; }
        ...
        public virtual ObjectResult<CalisanlarinYillaraGoreDagilimi_Result> CalisanlarinYillaraGoreDagilimi(Nullable<int> yil)
        {
            var yilParameter = yil.HasValue ?
                new ObjectParameter("yil", yil) :
                new ObjectParameter("yil", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<CalisanlarinYillaraGoreDagilimi_Result>("CalisanlarinYillaraGoreDagilimi", yilParameter);
        }
        ...
        public virtual int DortIslem(Nullable<int> sayi1, Nullable<int> sayi2)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DortIslem", sayi1Parameter, sayi2Parameter);
        }
        ...
        public virtual ObjectResult<MusterilerinDagilimi_Result> MusterilerinDagilimi(Nullable<int> yil)
        {
            var yilParameter = yil.HasValue ?
                new ObjectParameter("yil", yil) :
                new ObjectParameter("yil", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MusterilerinDagilimi_Result>("MusterilerinDagilimi", yilParameter);
        }
