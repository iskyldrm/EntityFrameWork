...
namespace NorthwindCoreEfDbFirst.Entities
{
    public partial class NorthwindDbContext : DbContext
    {
        ...
        public virtual DbSet<UrunlereGoreDagilimi> UrunlereGoreDagilimis { get; set; }
        public virtual DbSet<UrunlereGoreDagilimi2> UrunlereGoreDagilimi2s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UrunlereGoreDagilimi>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("UrunlereGoreDagilimi");

                entity.Property(e => e.Adet).HasColumnName("adet");

                entity.Property(e => e.Ciro)
                    .HasColumnType("money")
                    .HasColumnName("ciro");
            ...
            modelBuilder.Entity<UrunlereGoreDagilimi2>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("UrunlereGoreDagilimi2");
